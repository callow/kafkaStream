package kafka.stream.stateless.xmall.model;
...
public class Transaction {
    ...
    public static void main(String[] args) throws JsonProcessingException {
        Transaction transaction = Transaction.newBuilder().firstName("Alex").lastName("Wang").creditCardNumber("1234-1234-1234-8452")
                .itemPurchased("coffee").department("coffee").price(9.9D).quantity(1).zipCode("67500").purchaseDate(new Date())
                .customerId("C34573457443").build();
        ...
        Transaction result = mapper.readValue("{\"firstName\":\"Alex\",\"lastName\":\"Wang\",\"customerId\":\"C34573457443\",\"creditCardNumber\":\"1234-1234-1234-8452\",\"itemPurchased\":\"coffee\",\"department\":\"coffee\",\"quantity\":1,\"price\":9.9,\"purchaseDate\":\"2022-09-04T14:54:45.671+00:00\",\"zipCode\":\"67500\"}", Transaction.class);
